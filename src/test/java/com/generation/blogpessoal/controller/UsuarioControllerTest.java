...
public class UsuarioControllerTest {
	...
	@Test
	@DisplayName("😎 Deve fazer o Login")
	public void deveFazerLogin() {
		
			usuarioService.cadastrarUsuario(new Usuario(0L,
			"Gabriel", "gabriel@email.com.br", "12345678", "-"));
			
			UsuarioLogin usuarioLogin = new UsuarioLogin ("gabriel@email.com.br", "12345678");
	...
	public void DeveProcurarUsuarioPorId() {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L,
				"Beatriz", "beatriz@email.com.br", "12345678", "-"));
		
		ResponseEntity<Usuario> resposta = testRestTemplate
				.withBasicAuth("root@root.com", "rootroot")
				.exchange("/usuarios/7", HttpMethod.GET, null, Usuario.class);
